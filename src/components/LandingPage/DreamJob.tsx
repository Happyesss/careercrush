...
const DreamJob = () => {
  ...
  return (
    // <div className={'flex items-center bg-secondary px-20 bs-mx:px-10 md-mx:px-5 sm-mx:px-2 sm-mx:flex-col-reverse '}>
    ...
    <div className='flex  min-h-[100vh] items-start justify-center bg-secondary px-20 bs-mx:px-10 md-mx:px-5 sm-mx:px-2 sm-mx:flex-col-reverse '>
      <div className=' h-[100vh] pt-28 w-full flex flex-col  justify-start items-center'>
            ...
            <div className=' mt-8 text-center  px-8 flex items-center flex-col'>
            ...
            <div className='mt-6 flex items-center justify-center gap-4'>
                  <button className='bg-white  px-4 py-2 border text-black font-medium border-gray-200  dark:bg-third dark:border-none rounded-lg text-sm'>
                          Jobskeer
                  </button>

                  <button className='bg-primary text-white font-semibold px-4 py-2 rounded-lg text-sm'>
                          Mentor
                  </button>
            </div>
      ...
      <div className='h-[80vh] bg-slate-800 absolute w-[95%] md:w-[85%] rounded-xl top-[480px]'>
j
      </div>
